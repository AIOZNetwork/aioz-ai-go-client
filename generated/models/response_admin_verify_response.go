...
func (m *ResponseAdminVerifyResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseAdminVerifyResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAdminVerifyResponse) UnmarshalBinary(b []byte) error {
	var res ResponseAdminVerifyResponse
