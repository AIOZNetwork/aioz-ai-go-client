...
func (m *ResponseLikeDatasetListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseLikeDatasetListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLikeDatasetListData) UnmarshalBinary(b []byte) error {
	var res ResponseLikeDatasetListData
