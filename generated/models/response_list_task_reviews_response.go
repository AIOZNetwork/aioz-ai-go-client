...
func (m *ResponseListTaskReviewsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseListTaskReviewsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseListTaskReviewsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseListTaskReviewsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseListTaskReviewsResponse
