...
func (m *ResponseGetRepositoryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetRepositoryResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetRepositoryResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetRepositoryResponse
