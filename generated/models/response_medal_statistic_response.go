...
func (m *ResponseMedalStatisticResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseMedalStatisticResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseMedalStatisticResponse) UnmarshalBinary(b []byte) error {
	var res ResponseMedalStatisticResponse
