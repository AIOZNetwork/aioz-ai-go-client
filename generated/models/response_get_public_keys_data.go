...
func (m *ResponseGetPublicKeysData) validateKeys(formats strfmt.Registry) error {
...
func (m *ResponseGetPublicKeysData) contextValidateKeys(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetPublicKeysData) UnmarshalBinary(b []byte) error {
	var res ResponseGetPublicKeysData
