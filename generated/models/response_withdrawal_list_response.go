...
func (m *ResponseWithdrawalListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalListResponse
