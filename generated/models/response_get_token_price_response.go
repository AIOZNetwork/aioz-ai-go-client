...
func (m *ResponseGetTokenPriceResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetTokenPriceResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetTokenPriceResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetTokenPriceResponse
