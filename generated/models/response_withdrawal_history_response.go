...
func (m *ResponseWithdrawalHistoryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWithdrawalHistoryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalHistoryResponse
