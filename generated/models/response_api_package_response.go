...
func (m *ResponseAPIPackageResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseAPIPackageResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAPIPackageResponse) UnmarshalBinary(b []byte) error {
	var res ResponseAPIPackageResponse
