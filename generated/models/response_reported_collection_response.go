...
func (m *ResponseReportedCollectionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCollectionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionResponse) UnmarshalBinary(b []byte) error {
	var res ResponseReportedCollectionResponse
