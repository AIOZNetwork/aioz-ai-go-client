...
func (m *ResponseWalletWithAddressResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWalletWithAddressResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseWalletWithAddressResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWalletWithAddressResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWalletWithAddressResponse
