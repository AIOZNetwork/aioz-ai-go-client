...
func (m *ResponseBurnStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseBurnStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseBurnStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseBurnStatisticsResponse
