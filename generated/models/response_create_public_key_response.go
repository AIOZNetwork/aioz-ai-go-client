...
func (m *ResponseCreatePublicKeyResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCreatePublicKeyResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCreatePublicKeyResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCreatePublicKeyResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCreatePublicKeyResponse
