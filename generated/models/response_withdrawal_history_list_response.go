...
func (m *ResponseWithdrawalHistoryListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWithdrawalHistoryListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalHistoryListResponse
