...
func (m *ResponseUserEarningsStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseUserEarningsStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseUserEarningsStatisticsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseUserEarningsStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserEarningsStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseUserEarningsStatisticsResponse
