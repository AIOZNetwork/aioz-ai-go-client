...
func (m *ResponseAPIKeyHistoryListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseAPIKeyHistoryListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAPIKeyHistoryListData) UnmarshalBinary(b []byte) error {
	var res ResponseAPIKeyHistoryListData
