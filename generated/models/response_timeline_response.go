...
func (m *ResponseTimelineResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseTimelineResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTimelineResponse) UnmarshalBinary(b []byte) error {
	var res ResponseTimelineResponse
