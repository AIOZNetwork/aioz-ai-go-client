...
func (m *ResponseCompetitionListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseCompetitionListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCompetitionListData) UnmarshalBinary(b []byte) error {
	var res ResponseCompetitionListData
