...
func (m *ResponseModelListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseModelListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseModelListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseModelListResponse
