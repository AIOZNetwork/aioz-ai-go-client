...
func (m *ResponsePlaygroundLogListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponsePlaygroundLogListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundLogListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundLogListResponse) UnmarshalBinary(b []byte) error {
	var res ResponsePlaygroundLogListResponse
