...
func (m *ResponseContentConfigListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseContentConfigListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseContentConfigListData) UnmarshalBinary(b []byte) error {
	var res ResponseContentConfigListData
