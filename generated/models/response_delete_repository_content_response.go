...
func (m *ResponseDeleteRepositoryContentResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseDeleteRepositoryContentResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseDeleteRepositoryContentResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseDeleteRepositoryContentResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDeleteRepositoryContentResponse) UnmarshalBinary(b []byte) error {
	var res ResponseDeleteRepositoryContentResponse
