...
func (m *ResponseGetCollaboratorsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetCollaboratorsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetCollaboratorsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetCollaboratorsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetCollaboratorsResponse
