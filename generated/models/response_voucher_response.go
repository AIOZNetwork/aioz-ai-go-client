...
func (m *ResponseVoucherResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseVoucherResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseVoucherResponse) UnmarshalBinary(b []byte) error {
	var res ResponseVoucherResponse
