...
func (m *ResponseCheckedCommitListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseCheckedCommitListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCheckedCommitListData) UnmarshalBinary(b []byte) error {
	var res ResponseCheckedCommitListData
