...
func (m *ResponseDiscussionListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseDiscussionListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDiscussionListData) UnmarshalBinary(b []byte) error {
	var res ResponseDiscussionListData
