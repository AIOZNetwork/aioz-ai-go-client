...
func (m *ResponseDownloadModelListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseDownloadModelListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDownloadModelListData) UnmarshalBinary(b []byte) error {
	var res ResponseDownloadModelListData
