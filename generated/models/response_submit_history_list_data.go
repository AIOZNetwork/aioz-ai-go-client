...
func (m *ResponseSubmitHistoryListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseSubmitHistoryListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseSubmitHistoryListData) UnmarshalBinary(b []byte) error {
	var res ResponseSubmitHistoryListData
