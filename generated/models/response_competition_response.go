...
func (m *ResponseCompetitionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCompetitionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCompetitionResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCompetitionResponse
