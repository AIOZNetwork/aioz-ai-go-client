...
func (m *ResponseCustomMetricListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCustomMetricListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCustomMetricListResponse
