...
func (m *ResponseDatasetListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseDatasetListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDatasetListData) UnmarshalBinary(b []byte) error {
	var res ResponseDatasetListData
