...
func (m *ResponseCommentListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCommentListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCommentListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCommentListResponse
