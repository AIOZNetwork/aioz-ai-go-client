...
func (m *ResponseRefreshTokenResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseRefreshTokenResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseRefreshTokenResponse) UnmarshalBinary(b []byte) error {
	var res ResponseRefreshTokenResponse
