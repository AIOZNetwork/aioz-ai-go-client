...
func (m *ResponseCheckModelPendingStateResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCheckModelPendingStateResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCheckModelPendingStateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCheckModelPendingStateResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCheckModelPendingStateResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCheckModelPendingStateResponse
