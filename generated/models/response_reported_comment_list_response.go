...
func (m *ResponseReportedCommentListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCommentListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseReportedCommentListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedCommentListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseReportedCommentListResponse
