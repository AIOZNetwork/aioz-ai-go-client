...
func (m *ResponseCollectionListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseCollectionListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCollectionListData) UnmarshalBinary(b []byte) error {
	var res ResponseCollectionListData
