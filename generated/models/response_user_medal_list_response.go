...
func (m *ResponseUserMedalListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseUserMedalListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserMedalListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseUserMedalListResponse
