...
func (m *ResponseCheckModelIsServingResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCheckModelIsServingResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCheckModelIsServingResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCheckModelIsServingResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCheckModelIsServingResponse
