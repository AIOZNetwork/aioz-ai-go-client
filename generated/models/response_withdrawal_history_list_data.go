...
func (m *ResponseWithdrawalHistoryListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWithdrawalHistoryListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalHistoryListData) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalHistoryListData
