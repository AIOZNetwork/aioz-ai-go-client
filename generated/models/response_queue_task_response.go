...
func (m *ResponseQueueTaskResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseQueueTaskResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseQueueTaskResponse) UnmarshalBinary(b []byte) error {
	var res ResponseQueueTaskResponse
