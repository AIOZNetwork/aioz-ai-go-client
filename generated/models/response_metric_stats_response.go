...
func (m *ResponseMetricStatsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseMetricStatsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseMetricStatsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseMetricStatsResponse
