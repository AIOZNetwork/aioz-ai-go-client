...
func (m *ResponseGetUserByUsernameAndGuestIDData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetUserByUsernameAndGuestIDData) validateUser(formats strfmt.Registry) error {
...
func (m *ResponseGetUserByUsernameAndGuestIDData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetUserByUsernameAndGuestIDData) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetUserByUsernameAndGuestIDData) UnmarshalBinary(b []byte) error {
	var res ResponseGetUserByUsernameAndGuestIDData
