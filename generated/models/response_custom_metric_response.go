...
func (m *ResponseCustomMetricResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCustomMetricResponse
