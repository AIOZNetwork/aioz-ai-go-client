...
func (m *ResponseMakeOfferResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseMakeOfferResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseMakeOfferResponse) UnmarshalBinary(b []byte) error {
	var res ResponseMakeOfferResponse
