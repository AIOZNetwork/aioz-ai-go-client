...
func (m *ResponseMetadataResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseMetadataResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseMetadataResponse) UnmarshalBinary(b []byte) error {
	var res ResponseMetadataResponse
