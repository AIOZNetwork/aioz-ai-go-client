...
func (m *ResponseRepoStatsListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseRepoStatsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseRepoStatsListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseRepoStatsListResponse
