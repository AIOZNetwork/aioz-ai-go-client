...
func (m *ResponseUserMedalListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseUserMedalListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserMedalListData) UnmarshalBinary(b []byte) error {
	var res ResponseUserMedalListData
