...
func (m *ResponseLikeModelListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseLikeModelListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLikeModelListData) UnmarshalBinary(b []byte) error {
	var res ResponseLikeModelListData
