...
func (m *ResponseAdminDashboardStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseAdminDashboardStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseAdminDashboardStatisticsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseAdminDashboardStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAdminDashboardStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseAdminDashboardStatisticsResponse
