...
func (m *ModelsBranch) validateCommit(formats strfmt.Registry) error {
...
func (m *ModelsBranch) contextValidateCommit(ctx context.Context, formats strfmt.Registry) error {
