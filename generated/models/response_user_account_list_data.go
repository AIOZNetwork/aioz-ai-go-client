...
func (m *ResponseUserAccountListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseUserAccountListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserAccountListData) UnmarshalBinary(b []byte) error {
	var res ResponseUserAccountListData
