...
func (m *ResponseCompetitionActivitySummaryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCompetitionActivitySummaryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCompetitionActivitySummaryResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCompetitionActivitySummaryResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCompetitionActivitySummaryResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCompetitionActivitySummaryResponse
