...
func (m *ResponseReportedCommentListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCommentListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseReportedCommentListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedCommentListData) UnmarshalBinary(b []byte) error {
	var res ResponseReportedCommentListData
