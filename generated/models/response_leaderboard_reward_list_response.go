...
func (m *ResponseLeaderboardRewardListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseLeaderboardRewardListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardRewardListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardRewardListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseLeaderboardRewardListResponse
