...
func (m *ResponseGetTaskStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetTaskStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetTaskStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetTaskStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetTaskStatisticsResponse
