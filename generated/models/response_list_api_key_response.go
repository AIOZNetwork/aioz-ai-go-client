...
func (m *ResponseListAPIKeyResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseListAPIKeyResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseListAPIKeyResponse) UnmarshalBinary(b []byte) error {
	var res ResponseListAPIKeyResponse
