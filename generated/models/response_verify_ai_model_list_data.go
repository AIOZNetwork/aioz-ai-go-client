...
func (m *ResponseVerifyAiModelListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseVerifyAiModelListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseVerifyAiModelListData) UnmarshalBinary(b []byte) error {
	var res ResponseVerifyAiModelListData
