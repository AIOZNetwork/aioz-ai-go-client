...
func (m *ResponseGetCommitTreeResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetCommitTreeResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetCommitTreeResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetCommitTreeResponse
