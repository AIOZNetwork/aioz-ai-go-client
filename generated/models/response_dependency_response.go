...
func (m *ResponseDependencyResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseDependencyResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDependencyResponse) UnmarshalBinary(b []byte) error {
	var res ResponseDependencyResponse
