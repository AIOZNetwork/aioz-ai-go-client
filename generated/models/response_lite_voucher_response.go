...
func (m *ResponseLiteVoucherResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseLiteVoucherResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLiteVoucherResponse) UnmarshalBinary(b []byte) error {
	var res ResponseLiteVoucherResponse
