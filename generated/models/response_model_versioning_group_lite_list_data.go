...
func (m *ResponseModelVersioningGroupLiteListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseModelVersioningGroupLiteListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseModelVersioningGroupLiteListData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseModelVersioningGroupLiteListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseModelVersioningGroupLiteListData) UnmarshalBinary(b []byte) error {
	var res ResponseModelVersioningGroupLiteListData
