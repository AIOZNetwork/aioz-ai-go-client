...
func (m *ResponseModelVersioningGroupLiteResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseModelVersioningGroupLiteResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseModelVersioningGroupLiteResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseModelVersioningGroupLiteResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseModelVersioningGroupLiteResponse) UnmarshalBinary(b []byte) error {
	var res ResponseModelVersioningGroupLiteResponse
