...
func (m *ResponseCollectionListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCollectionListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCollectionListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCollectionListResponse
