...
func (m *ResponseGetOrganizationSettingResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetOrganizationSettingResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetOrganizationSettingResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetOrganizationSettingResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetOrganizationSettingResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetOrganizationSettingResponse
