...
func (m *ResponseGetOffersResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetOffersResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetOffersResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetOffersResponse
