...
func (m *ResponseReportedDiscussionListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedDiscussionListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionListData) UnmarshalBinary(b []byte) error {
	var res ResponseReportedDiscussionListData
