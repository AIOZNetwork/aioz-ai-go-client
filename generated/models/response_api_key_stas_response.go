...
func (m *ResponseAPIKeyStasResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseAPIKeyStasResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAPIKeyStasResponse) UnmarshalBinary(b []byte) error {
	var res ResponseAPIKeyStasResponse
