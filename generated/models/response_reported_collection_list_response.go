...
func (m *ResponseReportedCollectionListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCollectionListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCollectionListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseReportedCollectionListResponse
