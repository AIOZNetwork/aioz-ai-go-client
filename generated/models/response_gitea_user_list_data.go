...
func (m *ResponseGiteaUserListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseGiteaUserListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGiteaUserListData) UnmarshalBinary(b []byte) error {
	var res ResponseGiteaUserListData
