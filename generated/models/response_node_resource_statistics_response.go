...
func (m *ResponseNodeResourceStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseNodeResourceStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseNodeResourceStatisticsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseNodeResourceStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseNodeResourceStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseNodeResourceStatisticsResponse
