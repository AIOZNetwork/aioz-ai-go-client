...
func (m *ResponseGetPublicKeysResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetPublicKeysResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetPublicKeysResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetPublicKeysResponse
