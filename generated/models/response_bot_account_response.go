...
func (m *ResponseBotAccountResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseBotAccountResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseBotAccountResponse) UnmarshalBinary(b []byte) error {
	var res ResponseBotAccountResponse
