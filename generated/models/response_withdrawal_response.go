...
func (m *ResponseWithdrawalResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalResponse) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalResponse
