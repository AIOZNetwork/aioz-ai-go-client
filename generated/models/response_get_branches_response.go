...
func (m *ResponseGetBranchesResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetBranchesResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetBranchesResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetBranchesResponse
