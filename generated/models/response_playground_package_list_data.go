...
func (m *ResponsePlaygroundPackageListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponsePlaygroundPackageListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundPackageListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundPackageListData) UnmarshalBinary(b []byte) error {
	var res ResponsePlaygroundPackageListData
