...
func (m *ResponseSubmitHistoryListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseSubmitHistoryListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseSubmitHistoryListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseSubmitHistoryListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseSubmitHistoryListResponse
