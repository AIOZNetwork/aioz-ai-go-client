...
func (m *ResponseTransactionAnalyticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseTransactionAnalyticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseTransactionAnalyticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTransactionAnalyticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseTransactionAnalyticsResponse
