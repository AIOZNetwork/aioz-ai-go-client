...
func (m *ResponseApprovalRequestListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseApprovalRequestListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseApprovalRequestListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseApprovalRequestListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseApprovalRequestListResponse
