...
func (m *RequestAdminDeleteR2UrlsRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RequestAdminDeleteR2UrlsRequest) validateUrls(formats strfmt.Registry) error {
...
func (m *RequestAdminDeleteR2UrlsRequest) UnmarshalBinary(b []byte) error {
	var res RequestAdminDeleteR2UrlsRequest
