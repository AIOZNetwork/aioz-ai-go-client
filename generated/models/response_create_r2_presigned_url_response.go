...
func (m *ResponseCreateR2PresignedURLResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseCreateR2PresignedURLResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCreateR2PresignedURLResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCreateR2PresignedURLResponse) UnmarshalBinary(b []byte) error {
	var res ResponseCreateR2PresignedURLResponse
