...
func (m *ResponseReportedCollectionListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedCollectionListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedCollectionListData) UnmarshalBinary(b []byte) error {
	var res ResponseReportedCollectionListData
