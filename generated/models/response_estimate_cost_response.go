...
func (m *ResponseEstimateCostResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseEstimateCostResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseEstimateCostResponse) UnmarshalBinary(b []byte) error {
	var res ResponseEstimateCostResponse
