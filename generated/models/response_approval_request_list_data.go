...
func (m *ResponseApprovalRequestListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseApprovalRequestListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseApprovalRequestListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseApprovalRequestListData) UnmarshalBinary(b []byte) error {
	var res ResponseApprovalRequestListData
