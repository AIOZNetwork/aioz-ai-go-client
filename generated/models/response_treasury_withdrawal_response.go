...
func (m *ResponseTreasuryWithdrawalResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseTreasuryWithdrawalResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseTreasuryWithdrawalResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTreasuryWithdrawalResponse) UnmarshalBinary(b []byte) error {
	var res ResponseTreasuryWithdrawalResponse
