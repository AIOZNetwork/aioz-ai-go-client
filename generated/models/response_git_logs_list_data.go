...
func (m *ResponseGitLogsListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseGitLogsListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGitLogsListData) UnmarshalBinary(b []byte) error {
	var res ResponseGitLogsListData
