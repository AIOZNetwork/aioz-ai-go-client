...
func (m *ResponseMetadataListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseMetadataListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseMetadataListData) UnmarshalBinary(b []byte) error {
	var res ResponseMetadataListData
