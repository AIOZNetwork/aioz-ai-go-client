...
func (m *ResponseUserTrainingTaskListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseUserTrainingTaskListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseUserTrainingTaskListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserTrainingTaskListData) UnmarshalBinary(b []byte) error {
	var res ResponseUserTrainingTaskListData
