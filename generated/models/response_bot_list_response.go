...
func (m *ResponseBotListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseBotListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseBotListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseBotListResponse
