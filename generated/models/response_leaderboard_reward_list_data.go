...
func (m *ResponseLeaderboardRewardListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseLeaderboardRewardListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardRewardListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardRewardListData) UnmarshalBinary(b []byte) error {
	var res ResponseLeaderboardRewardListData
