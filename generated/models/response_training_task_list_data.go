...
func (m *ResponseTrainingTaskListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseTrainingTaskListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTrainingTaskListData) UnmarshalBinary(b []byte) error {
	var res ResponseTrainingTaskListData
