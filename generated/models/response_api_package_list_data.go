...
func (m *ResponseAPIPackageListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseAPIPackageListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseAPIPackageListData) UnmarshalBinary(b []byte) error {
	var res ResponseAPIPackageListData
