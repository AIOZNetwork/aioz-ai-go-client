...
func (m *ResponseGetAPIKeyPermissionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetAPIKeyPermissionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetAPIKeyPermissionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetAPIKeyPermissionResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetAPIKeyPermissionResponse
