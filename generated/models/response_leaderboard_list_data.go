...
func (m *ResponseLeaderboardListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLeaderboardListData) UnmarshalBinary(b []byte) error {
	var res ResponseLeaderboardListData
