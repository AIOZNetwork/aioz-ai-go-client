...
func (m *ResponseGetUserUploadsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetUserUploadsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetUserUploadsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetUserUploadsResponse
