...
func (m *ModelsCredential) validateUser(formats strfmt.Registry) error {
...
func (m *ModelsCredential) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
