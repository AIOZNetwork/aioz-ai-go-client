...
func (m *ResponseVoucherStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseVoucherStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseVoucherStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseVoucherStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseVoucherStatisticsResponse
