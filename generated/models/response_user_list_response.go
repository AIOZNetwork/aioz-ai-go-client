...
func (m *ResponseUserListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseUserListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseUserListResponse
