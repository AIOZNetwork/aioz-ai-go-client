...
func (m *ResponseQueueTaskListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseQueueTaskListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseQueueTaskListData) UnmarshalBinary(b []byte) error {
	var res ResponseQueueTaskListData
