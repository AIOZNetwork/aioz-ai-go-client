...
func (m *ResponseTrainingTaskResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseTrainingTaskResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTrainingTaskResponse) UnmarshalBinary(b []byte) error {
	var res ResponseTrainingTaskResponse
