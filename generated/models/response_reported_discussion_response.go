...
func (m *ResponseReportedDiscussionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedDiscussionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionResponse) UnmarshalBinary(b []byte) error {
	var res ResponseReportedDiscussionResponse
