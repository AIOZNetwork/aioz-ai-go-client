...
func (m *ResponseRepoStatsListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseRepoStatsListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseRepoStatsListData) UnmarshalBinary(b []byte) error {
	var res ResponseRepoStatsListData
