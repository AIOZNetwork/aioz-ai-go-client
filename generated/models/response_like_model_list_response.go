...
func (m *ResponseLikeModelListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseLikeModelListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLikeModelListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseLikeModelListResponse
