...
func (m *ResponseDependencyListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseDependencyListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDependencyListData) UnmarshalBinary(b []byte) error {
	var res ResponseDependencyListData
