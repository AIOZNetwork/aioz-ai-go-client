...
func (m *ResponseGetMetricsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetMetricsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetMetricsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetMetricsResponse
