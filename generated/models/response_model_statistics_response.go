...
func (m *ResponseModelStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseModelStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseModelStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseModelStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseModelStatisticsResponse
