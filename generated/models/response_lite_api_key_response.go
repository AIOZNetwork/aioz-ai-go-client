...
func (m *ResponseLiteAPIKeyResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseLiteAPIKeyResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLiteAPIKeyResponse) UnmarshalBinary(b []byte) error {
	var res ResponseLiteAPIKeyResponse
