...
func (m *ResponseWithdrawalListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWithdrawalListData) UnmarshalBinary(b []byte) error {
	var res ResponseWithdrawalListData
