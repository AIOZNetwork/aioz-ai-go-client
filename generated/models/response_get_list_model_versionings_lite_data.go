...
func (m *ResponseGetListModelVersioningsLiteData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetListModelVersioningsLiteData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseGetListModelVersioningsLiteData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetListModelVersioningsLiteData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetListModelVersioningsLiteData) UnmarshalBinary(b []byte) error {
	var res ResponseGetListModelVersioningsLiteData
