...
func (m *ResponseGetModelRewardStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetModelRewardStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetModelRewardStatisticsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetModelRewardStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetModelRewardStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetModelRewardStatisticsResponse
