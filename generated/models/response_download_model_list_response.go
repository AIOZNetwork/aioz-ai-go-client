...
func (m *ResponseDownloadModelListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseDownloadModelListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseDownloadModelListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDownloadModelListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseDownloadModelListResponse
