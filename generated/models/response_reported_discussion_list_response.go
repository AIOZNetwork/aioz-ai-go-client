...
func (m *ResponseReportedDiscussionListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedDiscussionListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseReportedDiscussionListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseReportedDiscussionListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseReportedDiscussionListResponse
