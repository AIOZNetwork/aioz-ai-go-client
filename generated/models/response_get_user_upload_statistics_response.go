...
func (m *ResponseGetUserUploadStatisticsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetUserUploadStatisticsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseGetUserUploadStatisticsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseGetUserUploadStatisticsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseGetUserUploadStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseGetUserUploadStatisticsResponse
