...
func (m *ResponseOrganizationListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseOrganizationListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseOrganizationListData) UnmarshalBinary(b []byte) error {
	var res ResponseOrganizationListData
