...
func (m *ResponsePlaygroundPackageResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponsePlaygroundPackageResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundPackageResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponsePlaygroundPackageResponse) UnmarshalBinary(b []byte) error {
	var res ResponsePlaygroundPackageResponse
