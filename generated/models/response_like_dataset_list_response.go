...
func (m *ResponseLikeDatasetListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseLikeDatasetListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseLikeDatasetListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseLikeDatasetListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseLikeDatasetListResponse
