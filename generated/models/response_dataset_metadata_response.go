...
func (m *ResponseDatasetMetadataResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseDatasetMetadataResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseDatasetMetadataResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDatasetMetadataResponse) UnmarshalBinary(b []byte) error {
	var res ResponseDatasetMetadataResponse
