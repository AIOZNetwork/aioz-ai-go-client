...
func (m *ResponseUserTrainingTaskListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseUserTrainingTaskListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseUserTrainingTaskListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseUserTrainingTaskListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseUserTrainingTaskListResponse
