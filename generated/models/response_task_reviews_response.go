...
func (m *ResponseTaskReviewsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseTaskReviewsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseTaskReviewsResponse) UnmarshalBinary(b []byte) error {
	var res ResponseTaskReviewsResponse
