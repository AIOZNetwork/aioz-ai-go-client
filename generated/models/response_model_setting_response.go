...
func (m *ResponseModelSettingResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseModelSettingResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseModelSettingResponse) UnmarshalBinary(b []byte) error {
	var res ResponseModelSettingResponse
