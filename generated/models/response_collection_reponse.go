...
func (m *ResponseCollectionReponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseCollectionReponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCollectionReponse) UnmarshalBinary(b []byte) error {
	var res ResponseCollectionReponse
