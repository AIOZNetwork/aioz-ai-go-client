...
func (m *ResponseListTimelinesResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseListTimelinesResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseListTimelinesResponse) UnmarshalBinary(b []byte) error {
	var res ResponseListTimelinesResponse
