...
func (m *ResponseCommentListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseCommentListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCommentListData) UnmarshalBinary(b []byte) error {
	var res ResponseCommentListData
