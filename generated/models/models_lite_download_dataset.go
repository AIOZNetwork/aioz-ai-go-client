...
func (m *ModelsLiteDownloadDataset) validateOwner(formats strfmt.Registry) error {
...
func (m *ModelsLiteDownloadDataset) contextValidateOwner(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsLiteDownloadDataset) UnmarshalBinary(b []byte) error {
	var res ModelsLiteDownloadDataset
