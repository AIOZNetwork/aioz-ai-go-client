...
func (m *ResponseCustomMetricListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseCustomMetricListData) UnmarshalBinary(b []byte) error {
	var res ResponseCustomMetricListData
