...
func (m *ResponseDiscussionListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseDiscussionListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDiscussionListResponse) UnmarshalBinary(b []byte) error {
	var res ResponseDiscussionListResponse
