...
func (m *ResponseEvaluationSettingResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseEvaluationSettingResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseEvaluationSettingResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseEvaluationSettingResponse) UnmarshalBinary(b []byte) error {
	var res ResponseEvaluationSettingResponse
