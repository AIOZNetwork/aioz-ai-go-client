...
func (m *ResponseDownloadDatasetListData) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseDownloadDatasetListData) validateRecords(formats strfmt.Registry) error {
...
func (m *ResponseDownloadDatasetListData) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseDownloadDatasetListData) UnmarshalBinary(b []byte) error {
	var res ResponseDownloadDatasetListData
