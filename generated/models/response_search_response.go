...
func (m *ResponseSearchResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResponseSearchResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseSearchResponse) UnmarshalBinary(b []byte) error {
	var res ResponseSearchResponse
