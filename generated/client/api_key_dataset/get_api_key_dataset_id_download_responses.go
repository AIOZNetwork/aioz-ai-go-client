...
func (o *GetAPIKeyDatasetIDDownloadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		result := NewGetAPIKeyDatasetIDDownloadOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewGetAPIKeyDatasetIDDownloadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewGetAPIKeyDatasetIDDownloadInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api-key/dataset/{id}/download] GetAPIKeyDatasetIDDownload", response, response.Code())
	}
}
...
func NewGetAPIKeyDatasetIDDownloadOK() *GetAPIKeyDatasetIDDownloadOK {
	return &GetAPIKeyDatasetIDDownloadOK{}
}
...
func (o *GetAPIKeyDatasetIDDownloadOK) Error() string {
	...
	return fmt.Sprintf("[GET /api-key/dataset/{id}/download][%d] getApiKeyDatasetIdDownloadOK %s", 200, payload)
}
...
func (o *GetAPIKeyDatasetIDDownloadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetAPIKeyDatasetIDDownloadBadRequest() *GetAPIKeyDatasetIDDownloadBadRequest {
	return &GetAPIKeyDatasetIDDownloadBadRequest{}
}
...
func (o *GetAPIKeyDatasetIDDownloadBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api-key/dataset/{id}/download][%d] getApiKeyDatasetIdDownloadBadRequest %s", 400, payload)
}
...
func (o *GetAPIKeyDatasetIDDownloadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetAPIKeyDatasetIDDownloadInternalServerError() *GetAPIKeyDatasetIDDownloadInternalServerError {
	return &GetAPIKeyDatasetIDDownloadInternalServerError{}
}
...
func (o *GetAPIKeyDatasetIDDownloadInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api-key/dataset/{id}/download][%d] getApiKeyDatasetIdDownloadInternalServerError %s", 500, payload)
}
...
func (o *GetAPIKeyDatasetIDDownloadInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
