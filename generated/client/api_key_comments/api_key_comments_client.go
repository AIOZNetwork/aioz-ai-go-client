...
// New creates a new api key comments API client with basic auth credentials.
...
// New creates a new api key comments API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) DeleteAPIKeyCommentsID(params *DeleteAPIKeyCommentsIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteAPIKeyCommentsIDOK, error) {
	...
	if params == nil {
		params = NewDeleteAPIKeyCommentsIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "DeleteAPIKeyCommentsID",
		Method:             "DELETE",
		...
		Params:             params,
		Reader:             &DeleteAPIKeyCommentsIDReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*DeleteAPIKeyCommentsIDOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for DeleteAPIKeyCommentsID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetAPIKeyDiscussionIDComments(params *GetAPIKeyDiscussionIDCommentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAPIKeyDiscussionIDCommentsOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetAPIKeyDiscussionIDCommentsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAPIKeyDiscussionIDComments",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAPIKeyDiscussionIDCommentsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetAPIKeyDiscussionIDCommentsOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAPIKeyDiscussionIDComments: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PostAPIKeyDiscussionIDComments(params *PostAPIKeyDiscussionIDCommentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PostAPIKeyDiscussionIDCommentsOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewPostAPIKeyDiscussionIDCommentsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PostAPIKeyDiscussionIDComments",
		Method:             "POST",
		PathPattern:        "/api-key/discussion/{id}/comments",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PostAPIKeyDiscussionIDCommentsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*PostAPIKeyDiscussionIDCommentsOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PostAPIKeyDiscussionIDComments: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PutAPIKeyCommentsID(params *PutAPIKeyCommentsIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PutAPIKeyCommentsIDOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewPutAPIKeyCommentsIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PutAPIKeyCommentsID",
		Method:             "PUT",
		PathPattern:        "/api-key/comments/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PutAPIKeyCommentsIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*PutAPIKeyCommentsIDOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PutAPIKeyCommentsID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
