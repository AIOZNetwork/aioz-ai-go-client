...
// New creates a new api key platform task API client with basic auth credentials.
...
// New creates a new api key platform task API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) GetAPIKeyPlatformTaskDatasetIDTraining(params *GetAPIKeyPlatformTaskDatasetIDTrainingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAPIKeyPlatformTaskDatasetIDTrainingOK, error) {
	...
	if params == nil {
		params = NewGetAPIKeyPlatformTaskDatasetIDTrainingParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAPIKeyPlatformTaskDatasetIDTraining",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &GetAPIKeyPlatformTaskDatasetIDTrainingReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetAPIKeyPlatformTaskDatasetIDTrainingOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for GetAPIKeyPlatformTaskDatasetIDTraining: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetAPIKeyPlatformTaskID(params *GetAPIKeyPlatformTaskIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAPIKeyPlatformTaskIDOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetAPIKeyPlatformTaskIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAPIKeyPlatformTaskID",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAPIKeyPlatformTaskIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetAPIKeyPlatformTaskIDOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAPIKeyPlatformTaskID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetAPIKeyPlatformTaskModelIDVerify(params *GetAPIKeyPlatformTaskModelIDVerifyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAPIKeyPlatformTaskModelIDVerifyOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetAPIKeyPlatformTaskModelIDVerifyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAPIKeyPlatformTaskModelIDVerify",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAPIKeyPlatformTaskModelIDVerifyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetAPIKeyPlatformTaskModelIDVerifyOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAPIKeyPlatformTaskModelIDVerify: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
