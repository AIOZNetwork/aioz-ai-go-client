...
func (o *GetSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api-key/search] getSearch", response, response.Code())
	}
}
...
func (o *GetSearchOK) Error() string {
	...
	return fmt.Sprintf("[GET /api-key/search][%d] getSearchOK %s", 200, payload)
}
...
func (o *GetSearchOK) GetPayload() *models.ResponseSearchResponse {
	return o.Payload
}
...
func (o *GetSearchBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api-key/search][%d] getSearchBadRequest %s", 400, payload)
}
...
func (o *GetSearchBadRequest) GetPayload() *models.ResponseFailResponse {
	return o.Payload
}
...
func (o *GetSearchInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api-key/search][%d] getSearchInternalServerError %s", 500, payload)
}
...
func (o *GetSearchInternalServerError) GetPayload() *models.ResponseErrorResponse {
	return o.Payload
}
