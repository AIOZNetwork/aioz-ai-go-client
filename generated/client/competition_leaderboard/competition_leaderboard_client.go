...
// New creates a new competition leaderboard API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new competition leaderboard API client with basic auth credentials.
...
// New creates a new competition leaderboard API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
Client for competition leaderboard API
*/
type Client struct {
