...
// NewPostModelListParams creates a new PostModelListParams object,
...
func NewPostModelListParams() *PostModelListParams {
	return &PostModelListParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostModelListParamsWithTimeout creates a new PostModelListParams object
...
// NewPostModelListParamsWithContext creates a new PostModelListParams object
...
// NewPostModelListParamsWithHTTPClient creates a new PostModelListParams object
...
func (o *PostModelListParams) WithContext(ctx context.Context) *PostModelListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostModelListParams) WithInput(input *models.RequestGetModelListRequest) *PostModelListParams {
	o.SetInput(input)
	return o
}

// SetInput adds the input to the post model list params
func (o *PostModelListParams) SetInput(input *models.RequestGetModelListRequest) {
	o.Input = input
}
